...
public class MigrationServiceOld {
	...
	private static final Logger logger = Logger.getLogger(MigrationServiceOld.class);
	...
	/**
	 * @see org.openuss.migration.MigrationServiceOld#performMigration()
	 */
	public synchronized void performMigration() throws java.lang.Exception {
...
//					FIXME institute.getAspirants().add(user);
				}
			} else {
...
//		FIXME institute.getGroups().add(groupAdmins);
//		FIXME institute.getGroups().add(groupAssistants);
//		FIXME institute.getGroups().add(groupTutors);
		
//		FIXME groups.addAll(institute.getGroups());
...
//		FIXME for (Course course: institute.getCourses()) {
//		FIXME 	objIds.add(createObjectIdentity(course.getId(),instituteObjId));
//		FIXME }
