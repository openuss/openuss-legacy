...
public class LegacyIdentifierDao extends SimpleJdbcDaoSupport implements InitializingBean {
	...
	private static final String SQL_INSERT_NEWSLETTER_SUBSCRIBER = "INSERT INTO NEWSLETTER_SUBSCRIBER (ID, BLOCKED, NEWSLETTER_FK, USER_FK) VALUES (GEN_ID(GLOBAL_SEQUENCE,1) , 0, ?, ?)";
