 ...
 * @author Kai Stettner
 */
@FacesValidator(value="organizationShortcutValidator")
public class OrganizationShortcutValidator extends BaseBean implements Validator {
	
	private static final Logger logger = Logger.getLogger(OrganizationShortcutValidator.class);
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		OrganisationService organisationService = (OrganisationService) getBean(Constants.ORGANISATION_SERVICE);
		try {
			boolean unique = organisationService.isNonExistingOrganisationShortcut(shortcut);
			if (!unique) {
