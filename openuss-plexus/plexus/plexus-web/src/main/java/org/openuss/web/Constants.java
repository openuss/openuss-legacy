...
public class Constants {
	...
	//Strings used by group package
	public static final String GROUP_ADMIN_INFO = "groupAdminInformationInfo";
	public static final String GROUP_WORKING_GROUP = "workingGroup";
	public static final String GROUP_NEWGROUP = "groups_new";
	public static final String GROUPS_ADMINISTRATION = "groups_administration";
	public static final String GROUPS_ADMIN_CUSTOM = "groups_admin_custom";
	public static final String GROUP_PARAMS = "group_params";
	public static final String GROUP_INFO = "groupInfo";
	public static final String GROUP_ASPIRATION_CONFIRMED = "group_aspiration_confirmed";
	public static final String GROUPS_GROUPS = "groups_groups";
	public static final String GROUPS_ASSIGN_CUSTOM = "groups_assign_custom";
}
