...
@View
public class NonOfficialDepartmentsPage extends BasePage{

	private static final Logger logger = Logger.getLogger(InstitutesPage.class);

	private static final long serialVersionUID = 6069635767478432045L;
	...
	public DataPage<DepartmentInfo> fetchDataPage(int startRow, int pageSize) {
		...
		if (dataPage == null) {
			...
			List<DepartmentInfo> departmentList = new ArrayList<DepartmentInfo>(departmentService.findDepartmentsByUniversityAndType(universityInfo.getId(), DepartmentType.NONOFFICIAL));
