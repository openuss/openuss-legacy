...
public class BrainContestInfo implements Serializable, DomainObject {
	...
	public BrainContestInfo(Long id, Long domainIdentifier, Date releaseDate, String description, String title,
			boolean released, Integer answers, Integer tries, String solution) {
		this.id = id;
	...
	public BrainContestInfo(Long id, Long domainIdentifier, Date releaseDate, String description, String title,
			boolean released, Integer answers, Integer tries, String solution, List<FileInfo> attachments) {
		this.id = id;
		this.domainIdentifier = domainIdentifier;
		this.releaseDate = releaseDate;
		this.description = description;
	...
	public BrainContestInfo(BrainContestInfo otherBean) {
		this(otherBean.getId(), otherBean.getDomainIdentifier(), otherBean.getReleaseDate(),
				otherBean.getDescription(), otherBean.getTitle(), otherBean.isReleased(), otherBean.getAnswers(),
				otherBean.getTries(), otherBean.getSolution(), otherBean.getAttachments());
	}
