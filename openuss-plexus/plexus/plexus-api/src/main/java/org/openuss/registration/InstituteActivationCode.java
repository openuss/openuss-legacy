 ...
 * 
 */
public interface InstituteActivationCode extends org.openuss.registration.ActivationCode,
	...
	public static abstract class Factory {
		...
		private static InstituteActivationCode.Factory getFactory() {
			if (factory == null) {
				factory = (InstituteActivationCode.Factory) org.openuss.api.utilities.FactoryFinder
						.find("org.openuss.registration.InstituteActivationCode.Factory");
			}
			return factory;
		}
		...
		public static org.openuss.registration.InstituteActivationCode newInstanceByIdentifier(Long id) {
			final org.openuss.registration.InstituteActivationCode entity = getFactory()
					.createInstituteActivationCode();
			entity.setId(id);
			return entity;
		}
		 ...
		 */
		public static org.openuss.registration.InstituteActivationCode newInstance(String code,
				java.sql.Timestamp createdAt, org.openuss.lecture.Institute institute) {
			final org.openuss.registration.InstituteActivationCode entity = getFactory()
					.createInstituteActivationCode();
			entity.setCode(code);
