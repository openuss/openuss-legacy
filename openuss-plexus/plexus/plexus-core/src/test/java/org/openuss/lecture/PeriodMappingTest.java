...
public class PeriodMappingTest extends TestCase {
	...
	public void testGenerateMapping() {
		...
		// To Period
		Period defaultPeriod = Period.Factory.newInstance("default", min, max, true);
		Period ss07 = Period.Factory.newInstance("ss07", d070401, d070930, false);
		Period ws07 = Period.Factory.newInstance("ws07", d071001, d080401, false);
		Period sep07 = Period.Factory.newInstance("sep07", d070901, d070930, false);
		...
		Period pOne = Period.Factory.newInstance("P", d070301, d070315, false);
		Period pTwo = Period.Factory.newInstance("P", d070301, d070415, false);
		Period pThree = Period.Factory.newInstance("P", d070401, d070930, false);
		Period pFour = Period.Factory.newInstance("P", d070415, d070915, false);
		Period pFive = Period.Factory.newInstance("P", d070915, d070930, false);
		Period pSix = Period.Factory.newInstance("P", d070915, d071001, false);
		Period pSeven = Period.Factory.newInstance("P", d071001, d071015, false);
		Period pEight = Period.Factory.newInstance("P", d071015, d071101, false);
		Period pNine = Period.Factory.newInstance("P", d071001,d080331, false);
		Period pTen = Period.Factory.newInstance("P", d200101,d190101, false);
