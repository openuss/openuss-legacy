 ...
 */
public abstract class NewsletterServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(NewsletterServiceIntegrationTestBase.class);
	...
	public void testNewsletterServiceInjection() {
