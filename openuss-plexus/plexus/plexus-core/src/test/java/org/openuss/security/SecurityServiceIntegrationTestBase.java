 ...
 */
public abstract class SecurityServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(SecurityServiceIntegrationTestBase.class);
