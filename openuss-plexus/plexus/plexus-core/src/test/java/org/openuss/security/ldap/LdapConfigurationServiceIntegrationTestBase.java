 ...
 */
public abstract class LdapConfigurationServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(LdapConfigurationServiceIntegrationTestBase.class);
	...
	public void testLdapConfigurationServiceInjection() {
		assertNotNull(ldapConfigurationService);
	}
