...
/**
 * JUnit Test for Spring Hibernate CourseNewsletterService class.
 * @see org.openuss.course.newsletter.CourseNewsletterService
 */
public abstract class CourseNewsletterServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(CourseNewsletterServiceIntegrationTestBase.class);
	...
	public void testCourseNewsletterServiceInjection() {
		assertNotNull(courseNewsletterService);
	}
