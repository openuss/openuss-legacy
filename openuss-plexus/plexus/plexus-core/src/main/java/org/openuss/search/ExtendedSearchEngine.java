...
/**
 * Lecture Extended Search Engine 
 * @author Kai Stettner
...
public class ExtendedSearchEngine {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(ExtendedSearchEngine.class);
	...
	public Hits search(String queryString) throws IOException {
		...
		logger.debug("Starting method search in Extended Search Engine");
