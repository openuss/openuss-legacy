 ...
 */
public abstract class InstituteActivationCodeDaoBase
    extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
    implements org.openuss.registration.InstituteActivationCodeDao
{
    ...
    public java.lang.Object load(final int transform, final java.lang.Long id)
    {
        if (id == null)
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.load - 'id' can not be null");
        }
    ...
    public java.lang.Object create(final int transform, final org.openuss.registration.InstituteActivationCode instituteActivationCode)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.create - 'instituteActivationCode' can not be null");
        }
    ...
    public java.util.Collection create(final int transform, final java.util.Collection<org.openuss.registration.InstituteActivationCode> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.create - 'entities' can not be null");
        }
    ...
    public void update(org.openuss.registration.InstituteActivationCode instituteActivationCode)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.update - 'instituteActivationCode' can not be null");
        }
        try {
    ...
    public void update(final java.util.Collection<org.openuss.registration.InstituteActivationCode> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.update - 'entities' can not be null");
        }
        this.getHibernateTemplate().execute(
            new org.springframework.orm.hibernate3.HibernateCallback()
            {
    ...
    public void remove(org.openuss.registration.InstituteActivationCode instituteActivationCode)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.remove - 'instituteActivationCode' can not be null");
        }
    ...
    public void remove(java.lang.Long id)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.remove - 'id can not be null");
        }
    ...
    public void remove(java.util.Collection<org.openuss.registration.InstituteActivationCode> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "InstituteActivationCode.remove - 'entities' can not be null");
        }
            ...
            if (results != null)
            {
                if (results.size() > 1)
                {
                    throw new org.springframework.dao.InvalidDataAccessResourceUsageException(
                        "More than one instance of 'org.openuss.registration.InstituteActivationCode"
