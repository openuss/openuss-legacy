 ...
 */
public abstract class OnlineSessionDaoBase
    extends org.springframework.orm.hibernate3.support.HibernateDaoSupport
    implements org.openuss.statistics.OnlineSessionDao
{
    ...
    public java.lang.Object load(final int transform, final java.lang.Long id)
    {
        if (id == null)
        {
            throw new IllegalArgumentException(
                "OnlineSession.load - 'id' can not be null");
        }
    ...
    public java.lang.Object create(final int transform, final org.openuss.statistics.OnlineSession onlineSession)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.create - 'onlineSession' can not be null");
        }
    ...
    public java.util.Collection create(final int transform, final java.util.Collection<org.openuss.statistics.OnlineSession> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.create - 'entities' can not be null");
        }
    ...
    public void update(org.openuss.statistics.OnlineSession onlineSession)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.update - 'onlineSession' can not be null");
        }
        try {
    ...
    public void update(final java.util.Collection<org.openuss.statistics.OnlineSession> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.update - 'entities' can not be null");
        }
        this.getHibernateTemplate().execute(
            new org.springframework.orm.hibernate3.HibernateCallback()
            {
    ...
    public void remove(org.openuss.statistics.OnlineSession onlineSession)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.remove - 'onlineSession' can not be null");
        }
    ...
    public void remove(java.lang.Long id)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.remove - 'id can not be null");
        }
    ...
    public void remove(java.util.Collection<org.openuss.statistics.OnlineSession> entities)
    {
        ...
        {
            throw new IllegalArgumentException(
                "OnlineSession.remove - 'entities' can not be null");
        }
        ...
        try
        {
            ...
            org.andromda.spring.CriteriaSearchParameter parameter1 =
                new org.andromda.spring.CriteriaSearchParameter(
                    ...
                    "startTime", org.andromda.spring.CriteriaSearchParameter.LESS_THAN_OR_EQUAL_COMPARATOR);
            ...
            org.andromda.spring.CriteriaSearchParameter parameter2 =
                new org.andromda.spring.CriteriaSearchParameter(
                    criteria.getEndTime(),
                    "endTime", true, org.andromda.spring.CriteriaSearchParameter.GREATER_THAN_COMPARATOR);
    ...
    public java.util.List findActiveUsers()
    {
        ...
        catch (Throwable th)
        {
            ...
            "Error performing 'org.openuss.statistics.OnlineSessionDao.findActiveUsers()' --> " + th,
            th);
        }
    }
      ...
      */
    protected abstract java.util.List handleFindActiveUsers()
    ...
    public org.openuss.statistics.OnlineInfo loadOnlineInfo()
    {
        ...
        {
            throw new java.lang.RuntimeException(
            "Error performing 'org.openuss.statistics.OnlineSessionDao.loadOnlineInfo()' --> " + th,
            th);
        }
    }
      ...
      */
    protected abstract org.openuss.statistics.OnlineInfo handleLoadOnlineInfo()
        throws java.lang.Exception;
     ...
     */
    private org.apache.commons.collections.Transformer ONLINEUSERINFO_TRANSFORMER =
    ...
    private final org.apache.commons.collections.Transformer OnlineUserInfoToEntityTransformer =
        new org.apache.commons.collections.Transformer()
        {
            public java.lang.Object transform(java.lang.Object input)
            {
    ...
    public void toOnlineUserInfo(
        org.openuss.statistics.OnlineSession source,
        org.openuss.statistics.OnlineUserInfo target)
    {
    ...
    public void onlineUserInfoToEntity(
        org.openuss.statistics.OnlineUserInfo source,
        org.openuss.statistics.OnlineSession target,
        boolean copyIfNull)
    {
