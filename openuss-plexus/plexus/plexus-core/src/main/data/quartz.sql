-- QUARTZ 1.5.2 TABLES --
CREATE TABLE QAURTZ_JOB_DETAILS (
...
CREATE TABLE QAURTZ_JOB_LISTENERS (
    JOB_NAME  VARCHAR(60) NOT NULL, 
    JOB_GROUP VARCHAR(60) NOT NULL,
    ...
    REFERENCES QAURTZ_JOB_DETAILS(JOB_NAME,JOB_GROUP) 
);

CREATE TABLE QAURTZ_TRIGGERS (
...
CREATE TABLE QAURTZ_SIMPLE_TRIGGERS (
    TRIGGER_NAME VARCHAR(60) NOT NULL,
    TRIGGER_GROUP VARCHAR(60) NOT NULL,
    ...
    REFERENCES QAURTZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP)
);

CREATE TABLE QAURTZ_CRON_TRIGGERS (
    TRIGGER_NAME VARCHAR(60) NOT NULL,
    TRIGGER_GROUP VARCHAR(60) NOT NULL,
...
CREATE TABLE QAURTZ_BLOB_TRIGGERS (
    TRIGGER_NAME VARCHAR(60) NOT NULL,
    TRIGGER_GROUP VARCHAR(60) NOT NULL,
    BLOB_DATA BLOB,
...
CREATE TABLE QAURTZ_TRIGGER_LISTENERS (
    TRIGGER_NAME  VARCHAR(60) NOT NULL, 
    TRIGGER_GROUP VARCHAR(60) NOT NULL,
...
CREATE TABLE QAURTZ_SCHEDULER_STATE (
    INSTANCE_NAME VARCHAR(60) NOT NULL,
...
CREATE TABLE QAURTZ_LOCKS (
    LOCK_NAME  VARCHAR(40) NOT NULL, 
    CONSTRAINT PK_QRTZ_LOCKS PRIMARY KEY (LOCK_NAME)
);

INSERT INTO QAURTZ_LOCKS VALUES('TRIGGER_ACCESS');
INSERT INTO QAURTZ_LOCKS VALUES('JOB_ACCESS');
INSERT INTO QAURTZ_LOCKS VALUES('CALENDAR_ACCESS');
INSERT INTO QAURTZ_LOCKS VALUES('STATE_ACCESS');
INSERT INTO QAURTZ_LOCKS VALUES('MISFIRE_ACCESS');
