...
public class FLGMindmapsMindmapElementContentPanel extends FSLAbstractLearningUnitViewElementContentPanel {
    ...
    public void saveUserChanges() {
        ...
        if (learningUnitViewElement.getMindmapFileName() == null) {
            mindmapsFile = learningUnitViewElementsManager.createNewFileForElementsExternalData(
                learningUnitViewElement.ELEMENT_TYPE_TEXT, ".mm",
                learningUnitViewElementId);
                learningUnitViewElement.setMindmapFileName(mindmapsFile.getName());
        } 
        else {
            String relativeFileName = learningUnitViewElementsManager.getRelativeFileNameVersionForWriting(
                learningUnitViewElement.getMindmapFileName(),
        ...
        if (learningUnitViewElementsManager != null && learningUnitViewElementId != null) {
            ...
            if (learningUnitViewElement != null) {
                if (learningUnitViewElement.getMindmapFileName() != null) {
                    ...
                    if (currentFile == null || !currentFile.equals(newFile) || reloadIfAlreadyLoaded)
                        try {
                            freemindInternalFrame.getController().getMode().getModeController().load(
                                learningUnitViewElementsManager.resolveRelativeFileName(learningUnitViewElement.getMindmapFileName(), learningUnitViewElement));
                        } 
                    ...
                    freemindInternalFrame.getController().getModel().setFile(
                        learningUnitViewElementsManager.resolveRelativeFileName("dummyFileName", learningUnitViewElement));
