 ...
 */
/*$Id: MapView.java,v 1.4 2004/09/01 04:46:45 jbrenni Exp $*/
...
import freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mindmaps.freemind.controller.NodeKeyListener;
import freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mindmaps.freemind.controller.NodeMouseMotionListener;
...
import freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mindmaps.freemind.modes.MindMapLink;
...
public class MapView extends JPanel implements Printable, Cloneable {
...
//                     }
    ...
    private class MapModelHandler implements TreeModelListener {
        ...
        public void treeNodesInserted( TreeModelEvent e ) {
            ...
            // FreeMindAdapter actually needs, which I find dubious.
    ...
    public MapView getCopy() {
	    MapView copy = null;
        try {
            copy = (MapView) this.clone();
        } catch (CloneNotSupportedException e) {
            System.out.println("Error while creating copy of MapView.");
        }
        return copy;
    }
