 ...
 */
/*$Id: MapModule.java,v 1.1 2004/08/24 17:03:33 jbrenni Exp $*/

package freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mindmaps.freemind.view;
...
public class MapModule {
	...
	if (getModel().toString() != null) {
	    ...
	    name = mode.getController().getFrame().getInternationalization("mindmap")
		       +unnamedMapsNumber++;
	}
    }
