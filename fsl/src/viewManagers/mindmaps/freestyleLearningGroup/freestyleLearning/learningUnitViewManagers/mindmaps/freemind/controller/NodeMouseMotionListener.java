 ...
 */
/*$Id: NodeMouseMotionListener.java,v 1.2 2004/08/28 05:33:02 jbrenni Exp $*/
...
public class NodeMouseMotionListener implements MouseMotionListener, MouseListener {
    ...
    public NodeMouseMotionListener(Controller controller) {
       c = controller; 
       if(logger == null)
           logger = c.getFrame().getLogger("freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mindmaps.freemind.controller.NodeMouseMotionListener");
   ...
   //  Invoked when the mouse button has been moved on a component (with no buttons down). 
    ...
    public void mouseEntered( MouseEvent e ) {
        ...
        c.getMode().getModeController().nodeEntered(e);
    }
    ...
    public void mouseExited( MouseEvent e ) {
        ...
        stopTimerForDelayedSelection();
        c.getMode().getModeController().nodeExited(e);
    }
