    ...
    implements Element, IdentifiableElement
{
    ...
    private String _MindmapFileName;
    ...
    public String getMindmapFileName() {
        return _MindmapFileName;
    }

    public void setMindmapFileName(String _MindmapFileName) {
        this._MindmapFileName = _MindmapFileName;
        if (_MindmapFileName == null) {
            invalidate();
        }
    }
        ...
        throws IOException
    {
        ...
        if (_MindmapFileName!= null) {
            w.attribute("mindmapFileName", _MindmapFileName.toString());
        }
        ...
        throws UnmarshalException
    {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("mindmapFileName")) {
                if (_MindmapFileName!= null) {
                    throw new DuplicateAttributeException(an);
                }
                _MindmapFileName = xs.takeAttributeValue();
                continue;
            }
    ...
    public boolean equals(Object ob) {
        ...
        if (_MindmapFileName!= null) {
            if (tob._MindmapFileName == null) {
                return false;
            }
            if (!_MindmapFileName.equals(tob._MindmapFileName)) {
                return false;
            }
        } else {
            if (tob._MindmapFileName!= null) {
    ...
    public int hashCode() {
        ...
        h = ((127 *h)+((_MindmapFileName!= null)?_MindmapFileName.hashCode(): 0));
    ...
    public String toString() {
        ...
        if (_MindmapFileName!= null) {
            sb.append(" mindmapFileName=");
            sb.append(_MindmapFileName.toString());
        }
        if (_LearningUnitViewElementLinks!= null) {
    ...
    public static Dispatcher newDispatcher() {
        return MindmapsDescriptor.newDispatcher();
    }
