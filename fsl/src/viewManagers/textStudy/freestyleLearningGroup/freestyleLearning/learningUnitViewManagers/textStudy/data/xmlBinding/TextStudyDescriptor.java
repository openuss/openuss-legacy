...
public class TextStudyDescriptor
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("textStudyDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("textStudyDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("textStudyDescriptor");
        ...
        xs.takeEnd("textStudyDescriptor");
    }

    public static TextStudyDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static TextStudyDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static TextStudyDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((TextStudyDescriptor) d.unmarshal(xs, (TextStudyDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof TextStudyDescriptor)) {
            return false;
        }
        TextStudyDescriptor tob = ((TextStudyDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<textStudyDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("textStudyDescriptor", (TextStudyDescriptor.class));
