    ...
    implements Element, IdentifiableElement
{
    ...
    public void setVideoFileName(String _VideoFileName) {
        ...
        throws LocalValidationException
    {
        ...
        if (_VideoFileName == null) {
            throw new MissingAttributeException("videoFileName");
        }
    }
        ...
        throws IOException
    {
        ...
        w.attribute("videoFileName", _VideoFileName.toString());
        ...
        throws UnmarshalException
    {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("videoFileName")) {
                if (_VideoFileName!= null) {
                    throw new DuplicateAttributeException(an);
                }
                _VideoFileName = xs.takeAttributeValue();
                continue;
            }
    ...
    public boolean equals(Object ob) {
        ...
        if (_VideoFileName!= null) {
            if (tob._VideoFileName == null) {
                return false;
            }
            if (!_VideoFileName.equals(tob._VideoFileName)) {
                return false;
            }
        } else {
            if (tob._VideoFileName!= null) {
    ...
    public int hashCode() {
        ...
        h = ((127 *h)+((_VideoFileName!= null)?_VideoFileName.hashCode(): 0));
    ...
    public String toString() {
        ...
        if (_VideoFileName!= null) {
            ...
            sb.append(_VideoFileName.toString());
        }
        if (_LearningUnitViewElementLinks!= null) {
    ...
    public static Dispatcher newDispatcher() {
        return IntroDescriptor.newDispatcher();
    }
