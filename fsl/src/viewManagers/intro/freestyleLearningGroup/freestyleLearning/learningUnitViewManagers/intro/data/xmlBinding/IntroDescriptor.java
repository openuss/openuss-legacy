...
package freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.intro.data.xmlBinding;
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("introDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("introDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeEnd("introDescriptor");
    }

    public static IntroDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static IntroDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static IntroDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((IntroDescriptor) d.unmarshal(xs, (IntroDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof IntroDescriptor)) {
            return false;
        }
        IntroDescriptor tob = ((IntroDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<introDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("introDescriptor", (IntroDescriptor.class));
