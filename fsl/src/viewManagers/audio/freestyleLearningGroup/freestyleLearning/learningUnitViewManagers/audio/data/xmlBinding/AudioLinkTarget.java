...
/**
 * Class for adding a linkTarget to the xml-structure.
 * @author Freestyle Learning Group
 * @author Gunnar Thies
 * @version 1.0, 15/04/03
 */
public class AudioLinkTarget extends MarshallableObject implements Element {
    ...
    public void marshal(Marshaller m) throws IOException {
        ...
        w.end("audioLinkTarget");
    }

    public void unmarshal(Unmarshaller u) throws UnmarshalException {
        XMLScanner xs = u.scanner();
        Validator v = u.validator();
        xs.takeStart("audioLinkTarget");
        ...
        xs.takeEnd("audioLinkTarget");
    }

    public static AudioLinkTarget unmarshal(InputStream in) throws UnmarshalException {
        return unmarshal(XMLScanner.open(in));
    }

    public static AudioLinkTarget unmarshal(XMLScanner xs) throws UnmarshalException {
        return unmarshal(xs, newDispatcher());
    }

    public static AudioLinkTarget unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return ((AudioLinkTarget)d.unmarshal(xs, (AudioLinkTarget.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        AudioLinkTarget tob = ((AudioLinkTarget)ob);
        if (_TargetLearningUnitViewManagerId != null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<audioLinkTarget");
        if (_TargetLearningUnitViewManagerId != null) {
