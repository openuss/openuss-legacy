    ...
    implements Element, IdentifiableElement
{
    ...
    private List _LearningUnitViewElementGridObjects = PredicatedLists.createInvalidating(this, new LearningUnitViewElementGridObjectsPredicate(), new ArrayList());
    private PredicatedLists.Predicate pred_LearningUnitViewElementGridObjects = new LearningUnitViewElementGridObjectsPredicate();
    ...
    public void setMusicFileName(String _MusicFileName) {
        this._MusicFileName = _MusicFileName;
    ...
    public List getLearningUnitViewElementGridObjects() {
        return _LearningUnitViewElementGridObjects;
    }

    public void deleteLearningUnitViewElementGridObjects() {
        _LearningUnitViewElementGridObjects = null;
        invalidate();
    }

    public void emptyLearningUnitViewElementGridObjects() {
        _LearningUnitViewElementGridObjects = PredicatedLists.createInvalidating(this, pred_LearningUnitViewElementGridObjects, new ArrayList());
    }
        ...
        throws StructureValidationException
    {
        ...
        for (Iterator i = _LearningUnitViewElementGridObjects.iterator(); i.hasNext(); ) {
            v.validate(((ValidatableObject) i.next()));
        }
    }
        ...
        throws IOException
    {
        ...
        if (_MusicFileName!= null) {
            w.attribute("musicFileName", _MusicFileName.toString());
        }
        ...
        if (_LearningUnitViewElementGridObjects.size()> 0) {
            for (Iterator i = _LearningUnitViewElementGridObjects.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        ...
        throws UnmarshalException
    {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("musicFileName")) {
                if (_MusicFileName!= null) {
                    throw new DuplicateAttributeException(an);
                }
                _MusicFileName = xs.takeAttributeValue();
                continue;
            }
        ...
        {
            List l = PredicatedLists.create(this, pred_LearningUnitViewElementGridObjects, new ArrayList());
            while (xs.atStart("viewElementGridObject")) {
                l.add(((ViewElementGridObject) u.unmarshal()));
            }
            _LearningUnitViewElementGridObjects = PredicatedLists.createInvalidating(this, pred_LearningUnitViewElementGridObjects, l);
        }
    ...
    public boolean equals(Object ob) {
        ...
        if (_MusicFileName!= null) {
            if (tob._MusicFileName == null) {
                return false;
            }
            if (!_MusicFileName.equals(tob._MusicFileName)) {
                return false;
            }
        } else {
            if (tob._MusicFileName!= null) {
        ...
        if (_LearningUnitViewElementGridObjects!= null) {
            if (tob._LearningUnitViewElementGridObjects == null) {
                return false;
            }
            if (!_LearningUnitViewElementGridObjects.equals(tob._LearningUnitViewElementGridObjects)) {
                return false;
            }
        } else {
            if (tob._LearningUnitViewElementGridObjects!= null) {
    ...
    public int hashCode() {
        ...
        h = ((127 *h)+((_MusicFileName!= null)?_MusicFileName.hashCode(): 0));
        h = ((127 *h)+((_LearningUnitViewElementLinks!= null)?_LearningUnitViewElementLinks.hashCode(): 0));
        h = ((127 *h)+((_LearningUnitViewElementGridObjects!= null)?_LearningUnitViewElementGridObjects.hashCode(): 0));
        return h;
    }
    ...
    public String toString() {
        ...
        if (_MusicFileName!= null) {
            ...
            sb.append(_MusicFileName.toString());
        }
        if (_LearningUnitViewElementLinks!= null) {
        ...
        if (_LearningUnitViewElementGridObjects!= null) {
            sb.append(" viewElementGridObject=");
            sb.append(_LearningUnitViewElementGridObjects.toString());
        }
        sb.append(">>");
        return sb.toString();
    }
    ...
    private static class LearningUnitViewElementGridObjectsPredicate
        implements PredicatedLists.Predicate
    {
        ...
        public void check(Object ob) {
            if (!(ob instanceof ViewElementGridObject)) {
                throw new InvalidContentObjectException(ob, (ViewElementGridObject.class));
            }
        }
