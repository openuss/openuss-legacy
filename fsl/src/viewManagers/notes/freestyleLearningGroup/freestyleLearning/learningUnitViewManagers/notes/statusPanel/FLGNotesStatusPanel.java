...
package freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.notes.statusPanel;

import freestyleLearning.learningUnitViewAPI.statusPanel.FSLAbstractLearningUnitViewStatusPanel;
import freestyleLearningGroup.independent.util.FLGInternationalization;

public class FLGNotesStatusPanel extends FSLAbstractLearningUnitViewStatusPanel {
    private FLGInternationalization internationalization;

    public FLGNotesStatusPanel() {
        internationalization = new FLGInternationalization("freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.notes.statusPanel.internationalization",
