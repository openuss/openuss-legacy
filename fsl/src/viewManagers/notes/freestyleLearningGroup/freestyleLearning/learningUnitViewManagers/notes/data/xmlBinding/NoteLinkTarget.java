...
public class NoteLinkTarget extends MarshallableObject implements Element {
    ...
    public void marshal(Marshaller m) throws IOException {
        ...
        w.end("noteLinkTarget");
    }

    public void unmarshal(Unmarshaller u) throws UnmarshalException {
        XMLScanner xs = u.scanner();
        Validator v = u.validator();
        xs.takeStart("noteLinkTarget");
        ...
        xs.takeEnd("noteLinkTarget");
    }

    public static NoteLinkTarget unmarshal(InputStream in) throws UnmarshalException {
        return unmarshal(XMLScanner.open(in));
    }

    public static NoteLinkTarget unmarshal(XMLScanner xs) throws UnmarshalException {
        return unmarshal(xs, newDispatcher());
    }

    public static NoteLinkTarget unmarshal(XMLScanner xs, Dispatcher d) throws UnmarshalException {
        return ((NoteLinkTarget)d.unmarshal(xs, (NoteLinkTarget.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        NoteLinkTarget tob = ((NoteLinkTarget)ob);
        if (_TargetLearningUnitViewManagerId != null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<noteLinkTarget");
        if (_TargetLearningUnitViewManagerId != null) {
