...
public class FLGNotesNoteElementContentPanel extends FSLAbstractLearningUnitViewElementContentPanel {
    ...
    public void init(FSLLearningUnitViewManager learningUnitViewManager,
        FSLLearningUnitEventGenerator learningUnitEventGenerator, boolean editMode) {
            ...
            learningUnitEventGenerator.addLearningUnitListener(new FLGNotesNoteElementContentPanel_LearningUnitAdapter());
            learningUnitViewManager.addLearningUnitViewListener(new FLGNotesNoteElementContentPanel_LearningUnitViewAdapter());
    }
    ...
    public void saveUserChanges() {
        File htmlFile;
        FLGNoteElement learningUnitViewElement = (FLGNoteElement)learningUnitViewElementsManager.getLearningUnitViewElement(learningUnitViewElementId, true);
        if (learningUnitViewElement.getHtmlFileName() == null) {
            htmlFile = learningUnitViewElementsManager.createNewFileForElementsExternalData(FLGNoteElement.ELEMENT_TYPE_NOTE,
            ...
            String relativeFileName = learningUnitViewElementsManager.getRelativeFileNameVersionForWriting(learningUnitViewElement.getHtmlFileName(),
                learningUnitViewElement, FLGNoteElement.ELEMENT_TYPE_NOTE, ".html");
...
/*
   class FLGNotesNoteElementContentPanel_HyperlinkListener implements HyperlinkListener {
...
*/
    ...
    class FLGNotesNoteElementContentPanel_LearningUnitAdapter extends FSLLearningUnitVetoableAdapter {
    ...
    class FLGNotesNoteElementContentPanel_LearningUnitViewAdapter extends FSLLearningUnitViewVetoableAdapter {
            ...
            if (event.getLearningUnitViewManagerId().equals(learningUnitViewManager.getLearningUnitViewManagerId())) {
                for (int i = 0; i < event.getLearningUnitViewElementIds().length; i++) {
                    if (event.getLearningUnitViewElementIds() [i].equals(learningUnitViewElementId)) {
                        String htmlFileName = ((FLGNoteElement)learningUnitViewElementsManager.getLearningUnitViewElement(learningUnitViewElementId,
