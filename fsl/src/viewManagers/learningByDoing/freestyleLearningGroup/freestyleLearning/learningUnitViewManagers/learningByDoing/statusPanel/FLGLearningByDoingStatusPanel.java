...
public class FLGLearningByDoingStatusPanel extends FSLAbstractLearningUnitViewStatusPanel {
    ...
    public FLGLearningByDoingStatusPanel() {
        internationalization = new FLGInternationalization("freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.learningByDoing.statusPanel.internationalization",
