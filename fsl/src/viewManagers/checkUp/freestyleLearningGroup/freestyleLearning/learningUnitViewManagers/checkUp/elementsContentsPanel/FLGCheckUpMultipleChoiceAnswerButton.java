...
public class FLGCheckUpMultipleChoiceAnswerButton extends
		FLGAbstractImageToggleButton {
	...
	public FLGCheckUpMultipleChoiceAnswerButton(Image unselectedImage,
			Image selectedImage, ActionListener actionListener) {
		buttonWidth = 36;
		buttonHeight = 36;
		imageWidth = 14;
		imageHeight = 14;
		if (BUTTON_NORMAL == null) {
			BUTTON_NORMAL = createButtonImage("images/multipleChoiceButtonNormal.gif");
			BUTTON_ROLLOVER = BUTTON_NORMAL;
			BUTTON_PRESSED = createButtonImage("images/multipleChoiceButtonPressed.gif");
			BUTTON_DISABLED = createButtonImage("images/multipleChoiceButtonDisabled.gif");
		}
	...
	public FLGCheckUpMultipleChoiceAnswerButton copy(
			ActionListener actionListener) {
		FLGCheckUpMultipleChoiceAnswerButton button = new FLGCheckUpMultipleChoiceAnswerButton();
	...
	private FLGCheckUpMultipleChoiceAnswerButton() {
	}
}
