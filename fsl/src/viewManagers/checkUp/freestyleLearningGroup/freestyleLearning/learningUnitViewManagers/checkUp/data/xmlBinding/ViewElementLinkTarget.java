...
public class ViewElementLinkTarget extends MarshallableObject implements
		Element {
	...
	public void setTargetLearningUnitViewManagerId(
			String _TargetLearningUnitViewManagerId) {
	...
	public void setTargetLearningUnitViewElementId(
			String _TargetLearningUnitViewElementId) {
	...
	public void marshal(Marshaller m) throws IOException {
		...
		w.attribute("targetViewManagerId", _TargetLearningUnitViewManagerId
				.toString());
		w.attribute("targetViewElementId", _TargetLearningUnitViewElementId
				.toString());
	...
	public static ViewElementLinkTarget unmarshal(InputStream in)
			throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static ViewElementLinkTarget unmarshal(XMLScanner xs)
			throws UnmarshalException {
		return unmarshal(xs, newDispatcher());
	}

	public static ViewElementLinkTarget unmarshal(XMLScanner xs, Dispatcher d)
			throws UnmarshalException {
		return ((ViewElementLinkTarget) d.unmarshal(xs,
				(ViewElementLinkTarget.class)));
	}
	...
	public boolean equals(Object ob) {
		...
		if (_TargetLearningUnitViewManagerId != null) {
			...
			if (!_TargetLearningUnitViewManagerId
					.equals(tob._TargetLearningUnitViewManagerId)) {
				return false;
			}
		} else {
			if (tob._TargetLearningUnitViewManagerId != null) {
		...
		if (_TargetLearningUnitViewElementId != null) {
			...
			if (!_TargetLearningUnitViewElementId
					.equals(tob._TargetLearningUnitViewElementId)) {
				return false;
			}
		} else {
			if (tob._TargetLearningUnitViewElementId != null) {
	...
	public int hashCode() {
		int h = 0;
		h = ((127 * h) + ((_TargetLearningUnitViewManagerId != null) ? _TargetLearningUnitViewManagerId
				.hashCode()
				: 0));
		h = ((127 * h) + ((_TargetLearningUnitViewElementId != null) ? _TargetLearningUnitViewElementId
				.hashCode()
				: 0));
		h = ((127 * h) + ((_TargetLearningUnitId != null) ? _TargetLearningUnitId
				.hashCode()
				: 0));
		return h;
	}
