...
public class MultipleChoiceAnswer extends MarshallableObject implements Element {
	...
	public void unmarshal(Unmarshaller u) throws UnmarshalException {
		...
		xs.takeEnd("multipleChoiceAnswer");
	}

	public static MultipleChoiceAnswer unmarshal(InputStream in)
			throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static MultipleChoiceAnswer unmarshal(XMLScanner xs)
			throws UnmarshalException {
		return unmarshal(xs, newDispatcher());
	}

	public static MultipleChoiceAnswer unmarshal(XMLScanner xs, Dispatcher d)
			throws UnmarshalException {
		return ((MultipleChoiceAnswer) d.unmarshal(xs,
	...
	public boolean equals(Object ob) {
		...
		MultipleChoiceAnswer tob = ((MultipleChoiceAnswer) ob);
		if (_Id != null) {
			if (tob._Id == null) {
				return false;
			}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("<<multipleChoiceAnswer");
		if (_Id != null) {
			sb.append(" id=");
