...
public class ViewElementLink extends MarshallableObject implements Element {
	...
	private List _LearningUnitViewElementLinkTargets = PredicatedLists
			.createInvalidating(this,
					new LearningUnitViewElementLinkTargetsPredicate(),
					new ArrayList());
	...
	public void emptyLearningUnitViewElementLinkTargets() {
		_LearningUnitViewElementLinkTargets = PredicatedLists
				.createInvalidating(this,
						pred_LearningUnitViewElementLinkTargets,
						new ArrayList());
	}
	...
	public void validate(Validator v) throws StructureValidationException {
		for (Iterator i = _LearningUnitViewElementLinkTargets.iterator(); i
				.hasNext();) {
	...
	public void unmarshal(Unmarshaller u) throws UnmarshalException {
		...
		}
		{
			List l = PredicatedLists.create(this,
					pred_LearningUnitViewElementLinkTargets, new ArrayList());
			while (xs.atStart("viewElementLinkTarget")) {
				l.add(((ViewElementLinkTarget) u.unmarshal()));
			}
			_LearningUnitViewElementLinkTargets = PredicatedLists
					.createInvalidating(this,
							pred_LearningUnitViewElementLinkTargets, l);
		}
		xs.takeEnd("viewElementLink");
	}

	public static ViewElementLink unmarshal(InputStream in)
			throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static ViewElementLink unmarshal(XMLScanner xs)
			throws UnmarshalException {
		return unmarshal(xs, newDispatcher());
	}

	public static ViewElementLink unmarshal(XMLScanner xs, Dispatcher d)
			throws UnmarshalException {
	...
	public boolean equals(Object ob) {
		...
		if (_LearningUnitViewElementLinkTargets != null) {
			...
			if (!_LearningUnitViewElementLinkTargets
					.equals(tob._LearningUnitViewElementLinkTargets)) {
				return false;
			}
		} else {
			if (tob._LearningUnitViewElementLinkTargets != null) {
	...
	public int hashCode() {
		...
		h = ((127 * h) + ((_LearningUnitViewElementLinkTargets != null) ? _LearningUnitViewElementLinkTargets
				.hashCode()
				: 0));
		return h;
	}
	...
	private static class LearningUnitViewElementLinkTargetsPredicate implements
