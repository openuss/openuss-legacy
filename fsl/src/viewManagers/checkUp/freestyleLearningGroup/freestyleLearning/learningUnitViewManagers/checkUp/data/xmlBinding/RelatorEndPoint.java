...
public class RelatorEndPoint extends MarshallableObject implements Element {
	...
	public void unmarshal(Unmarshaller u) throws UnmarshalException {
		...
		xs.takeEnd("relatorEndPoint");
	}

	public static RelatorEndPoint unmarshal(InputStream in)
			throws UnmarshalException {
		return unmarshal(XMLScanner.open(in));
	}

	public static RelatorEndPoint unmarshal(XMLScanner xs)
			throws UnmarshalException {
		return unmarshal(xs, newDispatcher());
	}

	public static RelatorEndPoint unmarshal(XMLScanner xs, Dispatcher d)
			throws UnmarshalException {
		return ((RelatorEndPoint) d.unmarshal(xs, (RelatorEndPoint.class)));
	}
	...
	public boolean equals(Object ob) {
		...
		RelatorEndPoint tob = ((RelatorEndPoint) ob);
		if (_Id != null) {
			if (tob._Id == null) {
				return false;
			}
	...
	public String toString() {
		StringBuffer sb = new StringBuffer("<<relatorEndPoint");
		if (_Id != null) {
			sb.append(" id=");
