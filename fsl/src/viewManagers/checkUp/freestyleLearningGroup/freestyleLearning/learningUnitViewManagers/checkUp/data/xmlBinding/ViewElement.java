...
public class ViewElement extends MarshallableObject implements Element,
		IdentifiableElement {
	...
	private List _LearningUnitViewElementLinks = PredicatedLists
			.createInvalidating(this,
					new LearningUnitViewElementLinksPredicate(),
					new ArrayList());

	private PredicatedLists.Predicate pred_LearningUnitViewElementLinks = new LearningUnitViewElementLinksPredicate();

	private List _GapTexts = PredicatedLists.createInvalidating(this,
			new GapTextsPredicate(), new ArrayList());

	private PredicatedLists.Predicate pred_GapTexts = new GapTextsPredicate();

	private List _MultipleChoices = PredicatedLists.createInvalidating(this,
			new MultipleChoicesPredicate(), new ArrayList());

	private PredicatedLists.Predicate pred_MultipleChoices = new MultipleChoicesPredicate();

	private List _Relators = PredicatedLists.createInvalidating(this,
			new RelatorsPredicate(), new ArrayList());

	private PredicatedLists.Predicate pred_Relators = new RelatorsPredicate();
	...
	public void emptyLearningUnitViewElementLinks() {
		_LearningUnitViewElementLinks = PredicatedLists.createInvalidating(
				this, pred_LearningUnitViewElementLinks, new ArrayList());
	}

	public List getGapTexts() {
		return _GapTexts;
	}

	public void deleteGapTexts() {
		_GapTexts = null;
		invalidate();
	}

	public void emptyGapTexts() {
		_GapTexts = PredicatedLists.createInvalidating(this, pred_GapTexts,
				new ArrayList());
	}

	public List getMultipleChoices() {
		return _MultipleChoices;
	}

	public void deleteMultipleChoices() {
		_MultipleChoices = null;
		invalidate();
	}

	public void emptyMultipleChoices() {
		_MultipleChoices = PredicatedLists.createInvalidating(this,
				pred_MultipleChoices, new ArrayList());
	}
	...
	public void deleteRelators() {
		_Relators = null;
		invalidate();
	}

	public void emptyRelators() {
		_Relators = PredicatedLists.createInvalidating(this, pred_Relators,
				new ArrayList());
	}
	...
	public void validate(Validator v) throws StructureValidationException {
		...
		for (Iterator i = _GapTexts.iterator(); i.hasNext();) {
			v.validate(((ValidatableObject) i.next()));
		}
		for (Iterator i = _MultipleChoices.iterator(); i.hasNext();) {
			v.validate(((ValidatableObject) i.next()));
		}
		for (Iterator i = _Relators.iterator(); i.hasNext();) {
			v.validate(((ValidatableObject) i.next()));
		}
	}
	...
	public void marshal(Marshaller m) throws IOException {
		...
		if (_LastModificationDate != null) {
			w.attribute("lastModificationDate", _LastModificationDate
					.toString());
		}
		w.attribute("folder", printBoolean(getFolder()));
		if (_LearningUnitViewElementLinks.size() > 0) {
			for (Iterator i = _LearningUnitViewElementLinks.iterator(); i
					.hasNext();) {
	...
	public void unmarshal(Unmarshaller u) throws UnmarshalException {
		...
		{
			List l = PredicatedLists.create(this,
					pred_LearningUnitViewElementLinks, new ArrayList());
			while (xs.atStart("viewElementLink")) {
				l.add(((ViewElementLink) u.unmarshal()));
			}
			_LearningUnitViewElementLinks = PredicatedLists.createInvalidating(
					this, pred_LearningUnitViewElementLinks, l);
		}
		{
			List l = PredicatedLists.create(this, pred_GapTexts,
					new ArrayList());
			while (xs.atStart("gapText")) {
				l.add(((GapText) u.unmarshal()));
			}
			_GapTexts = PredicatedLists.createInvalidating(this, pred_GapTexts,
					l);
		}
		{
			List l = PredicatedLists.create(this, pred_MultipleChoices,
					new ArrayList());
			while (xs.atStart("multipleChoice")) {
				l.add(((MultipleChoice) u.unmarshal()));
			}
			_MultipleChoices = PredicatedLists.createInvalidating(this,
					pred_MultipleChoices, l);
		}
		{
			List l = PredicatedLists.create(this, pred_Relators,
					new ArrayList());
			while (xs.atStart("relator")) {
				l.add(((Relator) u.unmarshal()));
			}
			_Relators = PredicatedLists.createInvalidating(this, pred_Relators,
					l);
		}
	...
	public boolean equals(Object ob) {
		...
		if (_LearningUnitViewElementLinks != null) {
			...
			if (!_LearningUnitViewElementLinks
					.equals(tob._LearningUnitViewElementLinks)) {
				return false;
			}
		} else {
			if (tob._LearningUnitViewElementLinks != null) {
		...
		if (_GapTexts != null) {
			if (tob._GapTexts == null) {
				return false;
			}
			if (!_GapTexts.equals(tob._GapTexts)) {
				return false;
			}
		} else {
			if (tob._GapTexts != null) {
		...
		if (_MultipleChoices != null) {
			if (tob._MultipleChoices == null) {
				return false;
			}
			if (!_MultipleChoices.equals(tob._MultipleChoices)) {
				return false;
			}
		} else {
			if (tob._MultipleChoices != null) {
		...
		if (_Relators != null) {
			if (tob._Relators == null) {
				return false;
			}
			if (!_Relators.equals(tob._Relators)) {
				return false;
			}
		} else {
			if (tob._Relators != null) {
	...
	public int hashCode() {
		...
		h = ((127 * h) + ((_LastModificationDate != null) ? _LastModificationDate
				.hashCode()
				: 0));
		h = ((127 * h) + ((_LearningUnitViewElementLinks != null) ? _LearningUnitViewElementLinks
				.hashCode()
				: 0));
		h = ((127 * h) + ((_GapTexts != null) ? _GapTexts.hashCode() : 0));
		h = ((127 * h) + ((_MultipleChoices != null) ? _MultipleChoices
				.hashCode() : 0));
		h = ((127 * h) + ((_Relators != null) ? _Relators.hashCode() : 0));
	...
	public String toString() {
		...
		if (_GapTexts != null) {
			sb.append(" gapText=");
			sb.append(_GapTexts.toString());
		}
		if (_MultipleChoices != null) {
			sb.append(" multipleChoice=");
			sb.append(_MultipleChoices.toString());
		}
		if (_Relators != null) {
			sb.append(" relator=");
			sb.append(_Relators.toString());
		}
		if (has_Folder) {
			sb.append(" folder=");
	...
	private static class LearningUnitViewElementLinksPredicate implements
			PredicatedLists.Predicate {

		public void check(Object ob) {
			if (!(ob instanceof ViewElementLink)) {
				throw new InvalidContentObjectException(ob,
						(ViewElementLink.class));
			}
		}

	}

	private static class GapTextsPredicate implements PredicatedLists.Predicate {

		public void check(Object ob) {
			if (!(ob instanceof GapText)) {
				throw new InvalidContentObjectException(ob, (GapText.class));
			}
		}

	}

	private static class MultipleChoicesPredicate implements
			PredicatedLists.Predicate {
	...
	private static class RelatorsPredicate implements PredicatedLists.Predicate {

		public void check(Object ob) {
			if (!(ob instanceof Relator)) {
				throw new InvalidContentObjectException(ob, (Relator.class));
			}
		}
