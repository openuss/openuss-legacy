...
public class FLGCheckUpElementsContentsPanel extends
		FSLAbstractLearningUnitViewElementsContentsPanel {
	...
	public void init(FSLLearningUnitViewManager learningUnitViewManager,
		...
		learningUnitViewManager
				.addLearningUnitViewListener(new FLGCheckUpElementsContentsPanel_LearningUnitViewAdapter());
		learningUnitViewManagerId = learningUnitViewManager
				.getLearningUnitViewManagerId();
		gapTextElementContentPanel = new FLGCheckUpGapTextElementContentPanel();
		gapTextElementContentPanel.init(learningUnitViewManager,
				learningUnitEventGenerator, editMode);
		multipleChoiceElementContentPanel = new FLGCheckUpMultipleChoiceElementContentPanel();
		multipleChoiceElementContentPanel.init(learningUnitViewManager,
				learningUnitEventGenerator, editMode);
		relatorElementContentPanel = new FLGCheckUpRelatorElementContentPanel();
		relatorElementContentPanel.init(learningUnitViewManager,
				learningUnitEventGenerator, editMode);
		evaluationManagerContentPanel = new FLGCheckUpEvaluationManagerContentPanel();
		evaluationManagerContentPanel.init(learningUnitViewManager,
				learningUnitEventGenerator, editMode);
	...
	public void setLearningUnitViewElementsManager(
		...
		gapTextElementContentPanel
				.setLearningUnitViewElementsManager(learningUnitViewElementsManager);
		multipleChoiceElementContentPanel
				.setLearningUnitViewElementsManager(learningUnitViewElementsManager);
		relatorElementContentPanel
				.setLearningUnitViewElementsManager(learningUnitViewElementsManager);
		evaluationManagerContentPanel
				.setLearningUnitViewElementsManager(learningUnitViewElementsManager);
		super
				.setLearningUnitViewElementsManager(learningUnitViewElementsManager);
	}
	...
	public void updateUI() {
		if (gapTextElementContentPanel != null)
			gapTextElementContentPanel.updateUI();
		if (multipleChoiceElementContentPanel != null)
			multipleChoiceElementContentPanel.updateUI();
		if (relatorElementContentPanel != null)
			relatorElementContentPanel.updateUI();
		if (evaluationManagerContentPanel != null)
			evaluationManagerContentPanel.updateUI();
		super.updateUI();
	}
	...
	class FLGCheckUpElementsContentsPanel_LearningUnitViewAdapter extends
		...
		public void learningUnitViewSpecificEventOccurred(
			...
			if (checkUpEvent.getEventSpecificType() == FLGCheckUpEvent.CHECKUP_EVALUATE_MODE_ENTERED) {
				evaluationMode = true;
				FSLLearningUnitViewEvent learningUnitEvent = FSLLearningUnitViewEvent
						.createElementActivatedEvent(learningUnitViewManagerId,
								activeCheckUpElementId, null, false);
				learningUnitViewManager
						.fireLearningUnitViewEvent(learningUnitEvent);
			}
		...
		public void learningUnitViewElementLinksRemoved(
				FSLLearningUnitViewEvent event) {
			if (event.getLearningUnitViewManagerId().equals(
				...
				if (element.getGapText() != null
						&& element.getGapText().getHtmlFormularFileName() != null)
					element
							.getGapText()
							.setHtmlFormularFileName(
									FSLLearningUnitViewUtilities
											.updateExternalHtmlFilesOnLinksRemovedEvent(
													event,
													learningUnitViewElementsManager,
													element,
													element
															.getGapText()
															.getHtmlFormularFileName(),
													FLGCheckUpElement.ELEMENT_TYPE_GAPTEXT,
													".html"));
				if (element.getMultipleChoice() != null) {
					String htmlFileName;
					// question
					htmlFileName = element.getMultipleChoice()
							.getQuestionHtmlFileName();
					if (htmlFileName != null)
						element
								.getMultipleChoice()
								.setQuestionHtmlFileName(
										FSLLearningUnitViewUtilities
												.updateExternalHtmlFilesOnLinksRemovedEvent(
														event,
														learningUnitViewElementsManager,
														...
														FLGCheckUpElement.ELEMENT_TYPE_MULTIPLECHOICE,
														".html"));
					for (int i = 0; i < element.getMultipleChoice()
							.getMultipleChoiceAnswers().size(); i++) {
						FLGCheckUpElementMultipleChoiceAnswer answer = (FLGCheckUpElementMultipleChoiceAnswer) element
								.getMultipleChoice().getMultipleChoiceAnswers()
								.get(i);
						if (answer.getHtmlFileName() != null) {
							answer
									.setHtmlFileName(FSLLearningUnitViewUtilities
											.updateExternalHtmlFilesOnLinksRemovedEvent(
													event,
													learningUnitViewElementsManager,
													element,
				...
				if (element.getRelator() != null) {
					String htmlFileName;
					// question
					htmlFileName = element.getRelator()
							.getQuestionHtmlFileName();
					if (htmlFileName != null)
						element
								.getRelator()
								.setQuestionHtmlFileName(
										FSLLearningUnitViewUtilities
												.updateExternalHtmlFilesOnLinksRemovedEvent(
														...
														FLGCheckUpElement.ELEMENT_TYPE_RELATOR,
														".html"));
					for (int i = 0; i < element.getRelator()
							.getRelatorStartPoints().size(); i++) {
						FLGCheckUpElementRelatorStartPoint startPoint = (FLGCheckUpElementRelatorStartPoint) element
					...
					for (int i = 0; i < element.getRelator()
							.getRelatorEndPoints().size(); i++) {
						FLGCheckUpElementRelatorEndPoint endPoint = (FLGCheckUpElementRelatorEndPoint) element
