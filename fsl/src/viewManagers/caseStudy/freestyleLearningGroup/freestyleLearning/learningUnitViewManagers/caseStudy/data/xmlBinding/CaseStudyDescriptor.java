...
public class CaseStudyDescriptor
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("caseStudyDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("caseStudyDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("caseStudyDescriptor");
        ...
        xs.takeEnd("caseStudyDescriptor");
    }

    public static CaseStudyDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static CaseStudyDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static CaseStudyDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((CaseStudyDescriptor) d.unmarshal(xs, (CaseStudyDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof CaseStudyDescriptor)) {
            return false;
        }
        CaseStudyDescriptor tob = ((CaseStudyDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<caseStudyDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("caseStudyDescriptor", (CaseStudyDescriptor.class));
