...
public class SlideShowDescriptor
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("slideShowDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("slideShowDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("slideShowDescriptor");
        ...
        xs.takeEnd("slideShowDescriptor");
    }

    public static SlideShowDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static SlideShowDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static SlideShowDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((SlideShowDescriptor) d.unmarshal(xs, (SlideShowDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof SlideShowDescriptor)) {
            return false;
        }
        SlideShowDescriptor tob = ((SlideShowDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<slideShowDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("slideShowDescriptor", (SlideShowDescriptor.class));
