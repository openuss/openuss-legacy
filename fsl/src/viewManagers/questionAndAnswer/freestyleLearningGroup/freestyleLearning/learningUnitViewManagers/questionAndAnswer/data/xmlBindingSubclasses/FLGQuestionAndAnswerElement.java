...
public class FLGQuestionAndAnswerElement extends ViewElement implements FSLLearningUnitViewElement {
    ...
    public FSLLearningUnitViewElement deepCopy() {
        FLGQuestionAndAnswerElement copy = new FLGQuestionAndAnswerElement();
    ...
    public FSLLearningUnitViewElementLink addNewLearningUnitViewElementLink() {
        FLGQuestionAndAnswerElementLink learningUnitViewElementLink = new FLGQuestionAndAnswerElementLink();
