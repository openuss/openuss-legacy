...
package freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.questionAndAnswer.data.xmlBinding;
...
public class QuestionAndAnswerDescriptor
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("questionAndAnswerDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("questionAndAnswerDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("questionAndAnswerDescriptor");
        ...
        xs.takeEnd("questionAndAnswerDescriptor");
    }

    public static QuestionAndAnswerDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static QuestionAndAnswerDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static QuestionAndAnswerDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((QuestionAndAnswerDescriptor) d.unmarshal(xs, (QuestionAndAnswerDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof QuestionAndAnswerDescriptor)) {
            return false;
        }
        QuestionAndAnswerDescriptor tob = ((QuestionAndAnswerDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<questionAndAnswerDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("questionAndAnswerDescriptor", (QuestionAndAnswerDescriptor.class));
