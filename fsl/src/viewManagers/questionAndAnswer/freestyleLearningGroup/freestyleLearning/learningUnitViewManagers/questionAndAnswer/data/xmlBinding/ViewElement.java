    ...
    implements Element, IdentifiableElement
{
    ...
    public void setStyleSheetFileName(String _StyleSheetFileName) {
        this._StyleSheetFileName = _StyleSheetFileName;
        if (_StyleSheetFileName == null) {
            invalidate();
        }
    }
        ...
        throws IOException
    {
        ...
        if (_StyleSheetFileName!= null) {
            w.attribute("styleSheetFileName", _StyleSheetFileName.toString());
        }
        ...
        throws UnmarshalException
    {
        ...
        while (xs.atAttribute()) {
            ...
            if (an.equals("styleSheetFileName")) {
                if (_StyleSheetFileName!= null) {
                    throw new DuplicateAttributeException(an);
                }
                _StyleSheetFileName = xs.takeAttributeValue();
                continue;
            }
    ...
    public boolean equals(Object ob) {
        ...
        if (_StyleSheetFileName!= null) {
            if (tob._StyleSheetFileName == null) {
                return false;
            }
            if (!_StyleSheetFileName.equals(tob._StyleSheetFileName)) {
                return false;
            }
        } else {
            if (tob._StyleSheetFileName!= null) {
    ...
    public int hashCode() {
        ...
        h = ((127 *h)+((_StyleSheetFileName!= null)?_StyleSheetFileName.hashCode(): 0));
    ...
    public String toString() {
        ...
        if (_StyleSheetFileName!= null) {
            sb.append(" styleSheetFileName=");
            sb.append(_StyleSheetFileName.toString());
        }
        if (_LearningUnitViewElementLinks!= null) {
    ...
    public static Dispatcher newDispatcher() {
        return QuestionAndAnswerDescriptor.newDispatcher();
    }
