    ...
    protected FSLAbstractLearningUnitViewElementContentPanel getElementContentPanel(int index, String learningUnitViewElementId) {
            ...
            if (mediaPoolElement != null) {
                if (mediaPoolElement.getFolder()) {
                    ...
                    if (mediaPoolElement.getType().equals("picture"))
                        return pictureElementContentPanels[index];
                    if (mediaPoolElement.getType().equals("pdf"))
                        return pdfElementContentPanel;
                    if (mediaPoolElement.getType().equals("video"))
                        return videoElementContentPanel;
                    if (mediaPoolElement.getType().equals("audio"))
                        return audioElementContentPanel;
                }
            }
            return null;
    }
