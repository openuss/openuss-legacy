...
import freestyleLearningGroup.freestyleLearning.learningUnitViewManagers.mediaPool.data.xmlBinding.ViewElement;
...
public class MediaPoolDescriptor
    ...
    implements RootElement
{
        ...
        throws IOException
    {
        ...
        w.start("mediaPoolDescriptor");
        if (_LearningUnitViewElements.size()> 0) {
            for (Iterator i = _LearningUnitViewElements.iterator(); i.hasNext(); ) {
                m.marshal(((MarshallableObject) i.next()));
            }
        }
        w.end("mediaPoolDescriptor");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("mediaPoolDescriptor");
        ...
        xs.takeEnd("mediaPoolDescriptor");
    }

    public static MediaPoolDescriptor unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static MediaPoolDescriptor unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static MediaPoolDescriptor unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((MediaPoolDescriptor) d.unmarshal(xs, (MediaPoolDescriptor.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        if (!(ob instanceof MediaPoolDescriptor)) {
            return false;
        }
        MediaPoolDescriptor tob = ((MediaPoolDescriptor) ob);
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<mediaPoolDescriptor");
        if (_LearningUnitViewElements!= null) {
    ...
    public static Dispatcher newDispatcher() {
        ...
        d.register("mediaPoolDescriptor", (MediaPoolDescriptor.class));
