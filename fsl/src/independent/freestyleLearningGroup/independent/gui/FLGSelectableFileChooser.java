...
public class FLGSelectableFileChooser extends JFileChooser {
    ...
    class SelectableFileFilter extends FileFilter {
        ...
        private void init() {
            if (selectableFileExtensions == null) showAllFiles = true;
            else if (selectableFileExtensions[0].equals(".*")) showAllFiles = true;
        }

        public boolean accept(File f) {
            if (showAllFiles || f.isDirectory()) return true;
            else {
                String fileName = f.getName().toLowerCase();
