...
public class TourElementLinkTarget
    ...
    implements Element
{
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("tourElementLinkTarget");
        ...
        xs.takeEnd("tourElementLinkTarget");
    }

    public static TourElementLinkTarget unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static TourElementLinkTarget unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static TourElementLinkTarget unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((TourElementLinkTarget) d.unmarshal(xs, (TourElementLinkTarget.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        TourElementLinkTarget tob = ((TourElementLinkTarget) ob);
        if (_TargetLearningUnitViewManagerId!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<tourElementLinkTarget");
        if (_TargetLearningUnitViewManagerId!= null) {
