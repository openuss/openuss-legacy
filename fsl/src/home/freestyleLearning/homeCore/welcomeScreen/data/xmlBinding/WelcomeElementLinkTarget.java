...
public class WelcomeElementLinkTarget
    ...
    implements Element
{
        ...
        throws IOException
    {
        ...
        w.start("welcomeElementLinkTarget");
        ...
        w.end("welcomeElementLinkTarget");
    }
        ...
        throws UnmarshalException
    {
        ...
        xs.takeStart("welcomeElementLinkTarget");
        ...
        xs.takeEnd("welcomeElementLinkTarget");
    }

    public static WelcomeElementLinkTarget unmarshal(InputStream in)
        throws UnmarshalException
    {
        return unmarshal(XMLScanner.open(in));
    }

    public static WelcomeElementLinkTarget unmarshal(XMLScanner xs)
        throws UnmarshalException
    {
        return unmarshal(xs, newDispatcher());
    }

    public static WelcomeElementLinkTarget unmarshal(XMLScanner xs, Dispatcher d)
        throws UnmarshalException
    {
        return ((WelcomeElementLinkTarget) d.unmarshal(xs, (WelcomeElementLinkTarget.class)));
    }
    ...
    public boolean equals(Object ob) {
        ...
        WelcomeElementLinkTarget tob = ((WelcomeElementLinkTarget) ob);
        if (_TargetLearningUnitViewManagerId!= null) {
    ...
    public String toString() {
        StringBuffer sb = new StringBuffer("<<welcomeElementLinkTarget");
        if (_TargetLearningUnitViewManagerId!= null) {
