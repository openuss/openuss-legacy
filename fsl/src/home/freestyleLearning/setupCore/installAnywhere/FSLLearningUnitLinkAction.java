        ...
        try {
            ...
            if (learningUnitsFound) {
                ...
                for (int i = 0; i < learningUnitDescriptors.size(); i++) {
                    ...
                    String learningUnitDirectoryName = learningUnitPath.substring(lastSeparatorIndex + 1,
                        learningUnitPath.length());
                    try {
                        // add descriptor entry
                        File learningUnitSourceDirectory = new
                            File(learningUnitsSourceDirectory.getAbsolutePath() + fileSeparator + learningUnitDirectoryName);
