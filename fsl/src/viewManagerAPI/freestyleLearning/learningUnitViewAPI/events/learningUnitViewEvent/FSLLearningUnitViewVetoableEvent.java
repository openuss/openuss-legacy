...
public class FSLLearningUnitViewVetoableEvent extends FSLLearningUnitViewEvent {
    ...
    public static FSLLearningUnitViewVetoableEvent
        createElementActivatingEvent(String learningUnitViewManagerId, String activeLearningUnitViewElementId,
        String secondaryActiveLearningUnitViewElementId, boolean elementsSwitchedOnly) {
    ...
    public static FSLLearningUnitViewVetoableEvent
        createElementsRemovingEvent(String learningUnitViewManagerId, String[] learningUnitViewElementIds) {
            FSLLearningUnitViewVetoableEvent event = new FSLLearningUnitViewVetoableEvent();
