	...
	protected Long handleCreateUniversity(UniversityInfo university, Long userId) {
		...
		period
				.setDescription("Dies ist der Standard-Zeitraum der "
						+ university.getName()
						+ ". Er ist als Auffangbeh�lter für Veranstaltungen gedacht, die keinem anderen Zeitraum zugeordnet werden k�nnen.");
		...
		department
				.setDescription("Dies ist das (inoffizielle) Standard-Fachbereich der "
						+ university.getName()
						+ ". Es ist als Auffangbeh�lter für Institutionen gedacht, die noch keinem anderen Fachbereich zugeordnet werden k�nnen.");
