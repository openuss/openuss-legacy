	...
	protected java.lang.Long handleCreateUniversity(org.openuss.lecture.UniversityInfo university, java.lang.Long userId) {
		...
		period
				.setDescription("Dies ist der Standard-Zeitraum der "
						+ university.getName()
						+ ". Er ist als Auffangbeh�lter für Veranstaltungen gedacht, die keinem anderen Zeitraum zugeordnet werden können.");
		...
		department
				.setDescription("Dies ist das (inoffizielle) Standard-Fachbereich der "
						+ university.getName()
						+ ". Es ist als Auffangbeh�lter für Institutionen gedacht, die noch keinem anderen Fachbereich zugeordnet werden können.");
