...
public class EnrollmentMailingListServiceImpl extends EnrollmentMailingListServiceBase {
	...
	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#sendPreview(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.mailinglist.MailDetail)
	 */
	protected void handleSendPreview(EnrollmentInfo enrollment, MailDetail mail) throws Exception {
	 ...
	 */
	protected List handleGetMails(EnrollmentInfo enrollment) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
	...
	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#sendMail(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.mailinglist.MailDetail)
	 */
	protected void handleSendMail(EnrollmentInfo enrollment, MailDetail mail) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
		getMailingListService().sendMail(mailingList, mail);
	}

	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#subscribe(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.security.User)
	 */
	protected void handleSubscribe(EnrollmentInfo enrollment, User user) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
		getMailingListService().subscribe(mailingList, user);
	}

	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#unsubscribe1(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.security.User)
	 */
	protected void handleUnsubscribe(EnrollmentInfo enrollment, User user) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
	...
	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#saveMail(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.mailinglist.MailDetail)
	 */
	protected void handleSaveMail(EnrollmentInfo enrollment, MailDetail mail) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
		getMailingListService().saveMail(mailingList, mail);
	}

	/**
	 * @see org.openuss.enrollment.mailinglist.EnrollmentMailingListService#deleteMail(org.openuss.lecture.EnrollmentInfo,
	 *      org.openuss.mailinglist.MailDetail)
	 */
	protected void handleDeleteMail(EnrollmentInfo enrollment, MailDetail mail) throws Exception {
		MailingListInfo mailingList = getMailingList(enrollment);
