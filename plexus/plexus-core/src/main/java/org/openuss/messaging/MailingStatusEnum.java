 ...
 * 
 */
public final class MailingStatusEnum
    extends MailingStatus
               ...
               org.hibernate.usertype.EnhancedUserType
{
    ...
    {
        return java.lang.String.valueOf(((org.openuss.messaging.MailingStatus)object).getValue());
    }
    ...
    {
        return org.openuss.messaging.MailingStatus.fromInteger(java.lang.Integer.valueOf(string));
    }
}