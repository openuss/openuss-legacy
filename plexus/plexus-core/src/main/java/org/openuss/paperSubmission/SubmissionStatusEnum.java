...
/**
 * Enumeration which identifies the PaperSubmission with the
 * values:
 * IN_TIME
 * NOT_IN_TIME
 * NOT_SUBMITTED
 ...
 */
public final class SubmissionStatusEnum
               ...
               org.hibernate.usertype.EnhancedUserType
{
    ...
    {
        return java.lang.String.valueOf(((org.openuss.paperSubmission.SubmissionStatus)object).getValue());
    }
    ...
    {
        return org.openuss.paperSubmission.SubmissionStatus.fromInteger(java.lang.Integer.valueOf(string));
    }
}