...
/**
 * JUnit Test for Spring Hibernate SerialAppointmentDao class.
 * @see org.openuss.calendar.SerialAppointmentDao
 */
public class SerialAppointmentDaoTest extends SerialAppointmentDaoTestBase {
	...
	public void testSerialAppointmentDaoCreate() {
		...
		serialAppointment.setRecurrenceType(null);
		serialAppointment.setRecurrencePeriod(null);
