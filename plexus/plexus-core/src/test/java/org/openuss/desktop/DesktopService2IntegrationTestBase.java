 ...
 */
public abstract class DesktopService2IntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(DesktopService2IntegrationTestBase.class);
	...
	public void testDesktopService2Injection() {
		assertNotNull(desktopService2);
	}
