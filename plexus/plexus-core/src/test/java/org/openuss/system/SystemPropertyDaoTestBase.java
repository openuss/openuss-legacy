 ...
 */
public abstract class SystemPropertyDaoTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(SystemPropertyDaoTestBase.class);

	protected SystemPropertyDao systemPropertyDao;
	...
	public void testSystemPropertyDaoInjection() {
		assertNotNull(systemPropertyDao);
	}
