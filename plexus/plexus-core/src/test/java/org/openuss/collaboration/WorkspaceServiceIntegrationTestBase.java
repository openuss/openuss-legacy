 ...
 */
public abstract class WorkspaceServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(WorkspaceServiceIntegrationTestBase.class);
	...
	public void testWorkspaceServiceInjection() {
