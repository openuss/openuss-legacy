 ...
 */
public abstract class WorkspaceDaoTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(WorkspaceDaoTestBase.class);
	...
	public void testWorkspaceDaoInjection() {
		assertNotNull(workspaceDao);
	}
