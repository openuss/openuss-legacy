 ...
 */
public class LdapTestLocal extends AbstractDependencyInjectionSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(LdapTestLocal.class);

	protected ProviderManager authManager;	
	
	protected UsernamePasswordAuthenticationToken ldapPswdAuthToken;
	
	public LdapTestLocal() {
		super();
	}
...
//		 !!!!!!!!!!!!! ATTENTION: DON't commit your personal password !!!!!!!!!!!!!!!!!!!!
		 										UsernamePasswordAuthenticationToken authRequest = new UsernamePasswordAuthenticationToken("defaultuser", "masterkey");
