 ...
 */
public abstract class PaperSubmissionServiceIntegrationTestBase extends AbstractTransactionalDataSourceSpringContextTests {
	
	protected static final Logger logger = Logger.getLogger(PaperSubmissionServiceIntegrationTestBase.class);
	...
	public void testPaperSubmissionServiceInjection() {
		assertNotNull(paperSubmissionService);
	}
