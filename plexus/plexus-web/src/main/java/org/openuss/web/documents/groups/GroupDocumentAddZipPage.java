...
@Bean(name = "views$secured$documents$groups$addzip", scope = Scope.REQUEST)
@View
public class GroupDocumentAddZipPage extends AbstractGroupDocumentPage{
		
	private static final Logger logger = Logger.getLogger(GroupDocumentAddZipPage.class);
