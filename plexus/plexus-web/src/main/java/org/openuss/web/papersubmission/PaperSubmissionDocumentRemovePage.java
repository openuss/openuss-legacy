...
@Bean(name = "views$secured$papersubmission$papersubmissionremove", scope = Scope.REQUEST)
@View
public class PaperSubmissionDocumentRemovePage extends AbstractPaperSubmissionPage {
