 ...
 *
 */
@Bean(name="views$secured$user$profilePersonal", scope=Scope.REQUEST)
@View
public class UserProfilePagePersonal extends BasePage{

	private static final Logger logger = Logger.getLogger(UserProfilePagePersonal.class);
