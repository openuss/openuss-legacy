...
@Bean(name = Constants.LDAP_ROLEATTRIBUTEKEYSET_REGISTRATION_CONTROLLER, scope = Scope.REQUEST)
@View
public class LdapRoleAttributeKeySetRegistrationController extends AbstractLdapRoleAttributeKeySetPage {

	
	private static final Logger logger = Logger.getLogger(LdapRoleAttributeKeySetRegistrationController.class);
	...
	*/
	...
	public String start() {
		...
		roleAttributeKeySetInfo = new RoleAttributeKeySetInfo();
		setSessionBean(Constants.ROLEATTRIBUTEKEYSET_INFO, roleAttributeKeySetInfo);
		
		return Constants.LDAP_ROLEATTRIBUTEKEYSET_REGISTRATION_STEP1_PAGE;
	}
...
*/
		return Constants.LDAP_ROLEATTRIBUTEKEYSET_PAGE;
	}
/*
