...
public class AuthenticationDomainNameUniqueValidator extends BaseBean implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		AuthenticationDomainInfo domainInfo = new AuthenticationDomainInfo();

		domainInfo.setName(authenticationDomainName);
		...
		if (authenticationDomainInfo.getName() != null	&& authenticationDomainInfo.getName().equals(authenticationDomainName)) {
			...
			boolean unique = ldapConfigurationService.isValidAuthenticationDomainName(domainInfo);
			if (!unique) {
