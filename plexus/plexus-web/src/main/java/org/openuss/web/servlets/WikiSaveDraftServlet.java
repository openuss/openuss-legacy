...
public class WikiSaveDraftServlet extends HttpServlet {
	...
	protected void doPost(final HttpServletRequest req, final HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.setHeader("Last-Modified", calculateModify());
		...
		// error result
		// <error errorNumber="' . $error . '" errorData="' .
		// saveAdapter::convertToXmlAttribute($errorData) . '" />

		out.println("</adapter>");
	}

	private static final String calculateModify() {
		Date mod = new Date();
