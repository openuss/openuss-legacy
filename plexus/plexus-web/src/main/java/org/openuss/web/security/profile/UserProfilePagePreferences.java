 ...
 *
 */
@Bean(name="views$secured$user$profilePref", scope=Scope.REQUEST)
@View
public class UserProfilePagePreferences extends BasePage{

	private static final Logger logger = Logger.getLogger(UserProfilePagePreferences.class);
