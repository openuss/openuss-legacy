 ...
 *
 */
@Bean(name="views$secured$user$profileUni", scope=Scope.REQUEST)
@View
public class UserProfilePageUni extends BasePage{

	private static final Logger logger = Logger.getLogger(UserProfilePageUni.class);
