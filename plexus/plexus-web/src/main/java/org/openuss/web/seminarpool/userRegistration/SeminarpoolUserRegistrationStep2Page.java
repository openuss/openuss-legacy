...
@Bean(name = "views$secured$seminarpool$userRegistration$seminarpooluserregistration_step2", scope = Scope.REQUEST)
@View
public class SeminarpoolUserRegistrationStep2Page extends
