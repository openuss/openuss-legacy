...
@Bean(name = "views$secured$documents$groups$remove", scope = Scope.REQUEST)
@View
public class GroupDocumentRemovePage extends AbstractGroupDocumentPage{
		
	private static final Logger logger = Logger.getLogger(GroupDocumentRemovePage.class);
	...
	/** 
	 * Remove the current group and all its data
