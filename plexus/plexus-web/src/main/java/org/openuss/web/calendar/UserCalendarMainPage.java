...
public class UserCalendarMainPage extends AbstractCalendarPage {
    ...
    public void changeToDayMode(ActionEvent event) {
    	if (model == null)
            return;
    	model.setMode(0);
    }
    
    public void changeToWorkWeekMode(ActionEvent event) {
    	if (model == null)
            return;
    	model.setMode(1);
    }
    
    public void changeToWeekMode(ActionEvent event) {
    	if (model == null)
            return;
    	model.setMode(2);
    }
    
    public void changeToMonthMode(ActionEvent event) {
    	if (model == null)
            return;
    	model.setMode(3);
    }
