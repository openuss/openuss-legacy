 ...
 */
@Bean(name = "views$secured$groups$groupnews", scope = Scope.REQUEST)
@View
public class GroupNewsPage extends AbstractGroupPage{
	...
	private void addPageCrumb() {
		...
		crumb.setName(i18n("group_command_options_news"));
		crumb.setHint(i18n("group_command_options_news"));
	...
	public String addNewsItem() {
		...
		newsItem.setPublisherName(groupInfo.getName());
