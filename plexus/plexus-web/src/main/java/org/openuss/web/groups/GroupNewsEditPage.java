 ...
 */
@Bean(name = "views$secured$groups$groupnewsedit", scope = Scope.REQUEST)
@View
public class GroupNewsEditPage extends AbstractGroupPage{
	...
	public void prerender() throws Exception {
		...
		newCrumb.setName(i18n("group_command_options_news"));
		newCrumb.setHint(i18n("group_command_options_news"));
	...
	public List<SelectItem> getNewsCategories() {
		...
		items.add(new SelectItem(NewsCategory.GROUP,i18n("news_category_course")));
		return items;
	}
