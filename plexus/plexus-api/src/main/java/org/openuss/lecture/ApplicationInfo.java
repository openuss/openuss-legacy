...
public class ApplicationInfo implements java.io.Serializable, org.openuss.foundation.DomainObject {
	...
	public ApplicationInfo(Long id, Date applicationDate, boolean confirmed,
			org.openuss.lecture.DepartmentInfo departmentInfo, org.openuss.lecture.InstituteInfo instituteInfo,
			org.openuss.security.UserInfo applyingUserInfo) {
		this.id = id;
	...
	public ApplicationInfo(Long id, Date applicationDate, Date confirmationDate, String description, boolean confirmed,
			org.openuss.lecture.DepartmentInfo departmentInfo, org.openuss.lecture.InstituteInfo instituteInfo,
			org.openuss.security.UserInfo applyingUserInfo, org.openuss.security.UserInfo confirmingUserInfo) {
		this.id = id;
		this.applicationDate = applicationDate;
	...
	public ApplicationInfo(ApplicationInfo otherBean) {
		this(otherBean.getId(), otherBean.getApplicationDate(), otherBean.getConfirmationDate(), otherBean
				.getDescription(), otherBean.isConfirmed(), otherBean.getDepartmentInfo(),
				otherBean.getInstituteInfo(), otherBean.getApplyingUserInfo(), otherBean.getConfirmingUserInfo());
	}
