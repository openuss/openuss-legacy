...
public class CourseMemberInfo implements java.io.Serializable {
	...
	public CourseMemberInfo(Long courseId, Long userId, String username, String firstName, String lastName,
			String email, org.openuss.lecture.CourseMemberType memberType, String title) {
	...
	public CourseMemberInfo(CourseMemberInfo otherBean) {
		this(otherBean.getCourseId(), otherBean.getUserId(), otherBean.getUsername(), otherBean.getFirstName(),
				otherBean.getLastName(), otherBean.getEmail(), otherBean.getMemberType(), otherBean.getTitle());
	}
