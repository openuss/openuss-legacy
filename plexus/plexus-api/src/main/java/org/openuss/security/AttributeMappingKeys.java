...
/**
 * Defines the global constants for the mapping of attributes.
 * It defines OpenUSS-specific attribute keys/attribute IDs, where 
 * to store and internally search for attribute values, that have been 
 * retrieved from directory services, e. g. LDAP.
 * <ol>
 *    <li>USERNAME_KEY</li>
 *    <li>FIRSTNAME_KEY</li>
 *    <li>LASTNAME_KEY</li>
