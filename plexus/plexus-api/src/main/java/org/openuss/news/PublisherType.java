...
public class PublisherType implements java.io.Serializable {
	 ...
	 */
	private static final long serialVersionUID = -7080063081324427411L;

	/**
     * 
     */
	public static final PublisherType INSTITUTE = new PublisherType(1);

	/**
     * 
     */
	public static final PublisherType COURSE = new PublisherType(2);

	private Integer value;

	private PublisherType(Integer value) {
		this.value = value;
	}
	...
	/**
	 * Creates an instance of PublisherType from <code>value</code>.
	 * 
	 * @param value
	 *            the value to create the PublisherType from.
	 */
	public static PublisherType fromInteger(Integer value) {
		final PublisherType typeValue = values.get(value);
		if (typeValue == null) {
	...
	public int compareTo(Object that) {
		return (this == that) ? 0 : this.getValue().compareTo(((PublisherType) that).getValue());
	}
	...
	public boolean equals(Object object) {
		return (this == object)
				|| (object instanceof PublisherType && ((PublisherType) object).getValue().equals(this.getValue()));
	}
	...
	private Object readResolve() throws java.io.ObjectStreamException {
		return PublisherType.fromInteger(this.value);
	}

	private static final Map<Integer, PublisherType> values = new HashMap<Integer, PublisherType>(2, 1);
