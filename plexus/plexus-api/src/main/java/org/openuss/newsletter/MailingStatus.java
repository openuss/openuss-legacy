...
public class MailingStatus implements java.io.Serializable {
	...
	public static final MailingStatus DELETED = new MailingStatus(6);
	...
	private static final Map<Integer, MailingStatus> values = new HashMap<Integer, MailingStatus>(6, 1);
	private static List<Integer> literals = new ArrayList<Integer>(6);
