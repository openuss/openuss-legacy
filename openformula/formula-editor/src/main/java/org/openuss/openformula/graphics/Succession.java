...
public final class Succession extends Basic implements BuildStructure {
    ...
    *
     ...
     * @param element Einzuf�gendes Objekt
     */
    ...
    /**
     * Normalerweise wird bei Anfragen an die H�he ein Minimalwert zurückgegeben. Sollte dies
    ...
    /**
     * Ein Objekt wird beim Cursor eingef�gt. Der Cursor wird hinter das neue Objekt verschoben.
    ...
    //    /**
    //     * Ein Objekt wird an das Ende angef�gt. Der Cursor wird nicht verschoben. Dient Debug-Zwecken.
    //     * @param insert Einzuf�gendes Objekt.
    //     */
     ...
     * der Liste eingef�gt. Bei einem Wert größer als die L�nge der Liste wird er an das Ende der Liste angef�gt.
    ...
    /**
     * Der Cursor wird links von diesem Objekt eingef�gt. Das Objekt muss in der Liste der Unterobjekte existieren.
     * Falls der Cursor einem anderen Objekt zugeordnet war, so wird die Zuordnung angepasst.
     * @param object Objekt, neben dem der Cursor eingef�gt werden soll.
     */
    ...
    /**
     * Der Cursor wird rechts von diesem Objekt eingef�gt. Das Objekt muss in der Liste der Unterobjekte existieren.
     * Falls der Cursor einem anderen Objekt zugeordnet war, so wird die Zuordnung angepasst.
     * @param object Objekt, neben dem der Cursor eingef�gt werden soll.
     */
     ...
     * Falls eine Bewegung nach oben ausgef�hrt wird und ein Zeilenbruch vorhanden ist, wird der Cursor
     * in der untersten Linie eingef�gt.
     * @param g Grafikkontext
     * @param xPosition relative XPosition.
     * @param goUp Eine Bewegung nach oben wurde ausgef�hrt.
     */
