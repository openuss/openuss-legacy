 ...
 *  </dl>
 *
 * @see     org.openuss.openformula.mathml.in.java_cup.runtime.Symbol
 * @see     org.openuss.openformula.mathml.in.java_cup.runtime.Symbol
 * @see     org.openuss.openformula.mathml.in.java_cup.runtime.virtual_parse_stack
 ...
 *  it recovered from.
 */
    private final static int _error_sync_size = 3;
 ...
 *  recovered from.
 */
    private static int error_sync_size() {
 ...
 *
 * @see org.openuss.openformula.mathml.in.java_cup.runtime.lr_parser#get_action
 */
 ...
 *
 * @see org.openuss.openformula.mathml.in.java_cup.runtime.lr_parser#get_reduce
 */
 ...
 */
    public final void done_parsing() {
        _done_parsing = true;
    }
 ...
 */
    private void setScanner(final Scanner s) {
        _scanner = s;
    }
 ...
 */
    protected abstract Symbol do_action(int act_num, lr_parser parser, 
                                        Stack stack, int top)
 ...
 *  clause as its body.
 */
    private static void user_init() throws java.lang.Exception {
    }
 ...
 */
    private Symbol scan() throws java.lang.Exception {
 ...
 */
    protected void report_fatal_error(final String message, final Object info)
                               throws java.lang.Exception {
 ...
 * @param info    an extra object reserved for use by specialized subclasses.
 */
    protected void report_error(final String message, final Object info) {
 ...
 */
    protected void syntax_error(final Symbol cur_token) {
 ...
 * @param cur_token the current lookahead Symbol.
 */
    protected void unrecovered_syntax_error(final Symbol cur_token)
                                     throws java.lang.Exception {
 ...
 */
    private short get_action(final int state, final int sym) {
        short tag;
        int first;
        int last;
        int probe;
 ...
 */
    private short get_reduce(final int state, final int sym) {
        short tag;
 ...
 */
    public final Symbol parse() throws java.lang.Exception {
 ...
 */
    private static void debug_message(final String mess) {
 ...
 */
    private void debug_reduce(final int prod_num, final int nt_num, 
                              final int rhs_size) {
 ...
 */
    private void debug_shift(final Symbol shift_tkn) {
 ...
 */
    public final Symbol debug_parse() throws java.lang.Exception {
        /* the current action code */
        int act;
 ...
 */
    private boolean error_recovery(final boolean debug)
                            throws java.lang.Exception {
        if (debug) {
 ...
 * @param debug should we produce debugging messages as we parse.
 */
    private boolean find_recovery_config(final boolean debug) {
        final Symbol error_token;
        final int act;
 ...
 *  Symbols.
 */
    private void read_lookahead() throws java.lang.Exception {
 ...
 */
    private void restart_lookahead() throws java.lang.Exception {
 ...
 * @param debug should we produce debugging messages as we parse.
 */
    private boolean try_parse_ahead(final boolean debug)
                             throws java.lang.Exception {
        int act;
        short lhs;
        short rhs_size;
 ...
 * @param debug should we produce debugging messages as we parse.
 */
    private void parse_lookahead(final boolean debug) throws java.lang.Exception {
        /* the current action code */
        int act;
   ...
   (shouldn't happen here, but...)*/
    ...
    protected static short[][] unpackFromStrings(final String[] sa) {
        ...
        final int size1 = ((int) sb.charAt(n) << 16) | 
                          (int) sb.charAt(n + 1);
        n += 2;
        ...
        for (int i = 0; i < size1; i++) {
            final int size2 = ((int) sb.charAt(n) << 16) | 
                              (int) sb.charAt(n + 1);
            n += 2;
