...
/**
 * Stellt den eigentlichen Formeleditor in einem Fenster dar. Diese Routiene verf�gt
...
public final class EditorFrame extends Frame {
     ...
     * eigenst�ndiges Java-Programm. (Ausbaubed�rftig.) b) Nutzung innerhalb des Applets
     * als Editor.
     */
    public EditorFrame() {
    ...
    /**
     * Hauptfunktion - erstellt die Zeichenfl�che
    ...
    /**
     *  übertr�gt den Focus auf das Fenster
     */
    ...
    /**
     * überpr�ft, ob das Fenster geschlossen wurde.
