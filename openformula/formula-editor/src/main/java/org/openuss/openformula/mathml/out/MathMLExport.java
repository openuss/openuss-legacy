...
public final class MathMLExport {
    ...
    /**
     * Eine Textzeile in den tempor�ren Buffer zufügen. Es wird kein unsichtbarer Operator eingefügt.
    ...
    /**
     * L�scht das zuletzt eingegebene Element und gibt es als String zurück.
    ...
    protected final class Layer {
        ...
        public final void addTextLine(final String str) {
            ifNessesaryAddDigits(); // Eigenes Objekt für Zahlen einfügen, wenn n�tig
        ...
        final void ifNessesaryAddDigits() {
            if (chars.length() != 0) {
                ...
                try {
                    ...
                    // überpr�fung, ob g�ltiger mathematischer Ausdruck
