 ...
 * Des weiteren stehen Funktionen zur Verf�gung, die einzelne Zeichen einfügen können.
 */
public final class InsertSymbol {
    ...
    /**
     * Konstante für "Punkt über letztem Zeichen anf�gen"
     */
    public final static int AddDotToLetter = 15;

    /**
     * Konstante für "Zwei Punkte über letztem Zeichen anf�gen"
     */
    public final static int AddDoubleDotToLetter = 16;

    /**
     * Konstante für "Drei Punkte über letztem Zeichen anf�gen"
     */
    public final static int AddTripleDotToLetter = 17;

    /**
     * Konstante für "Hut über letztem Zeichen anf�gen"
     */
    public final static int AddHatToLetter = 18;

    /**
     * Konstante für "Balken über letztem Zeichen anf�gen"
     */
    public final static int AddOverBarToLetter = 19;

    /**
     * Tilde für "Balken über letztem Zeichen anf�gen"
     */
    ...
    /**
     * Erzeugt ein Objekt, das bei Aufruf von InsertNow() das hier eingestellte
     * Objekt einf�gt. Erlaubt als zus�tzlichen Parameter die übergabe eines Zeichens.
     ...
     * eingef�gt werden können. InsertNow() darf bei einem Objekt, dass mit diesem
    ...
    /**
     * Diese Methode erstellt ein Objekt gem�� der beim Konstruktor übergebenen
