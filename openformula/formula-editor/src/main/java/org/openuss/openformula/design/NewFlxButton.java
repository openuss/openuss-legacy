 ...
 * Es findet keine überpr�fung statt, ob die Komponente eingezeichnet werden kann.
 */
public final class NewFlxButton extends Canvas implements MouseListener {
     ...
     * @param sizeX Horizontale Ausdehnung
     * @param sizeY Vertikale Ausdehnung
     * @param symbol Vorgagang, der bei Bet�tigung dieses Knopfes ausgel�st werden soll.
     */
