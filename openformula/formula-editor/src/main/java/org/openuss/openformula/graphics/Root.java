...
public final class Root extends HorizontalEnter {
    ...
    public final void paint(final Graphics g, final int atX, final int atY) {
        ...
        int l1x = mySize / 10; // L�nge der ersten Linie
        ...
        int l2x = mySize / 10; // Vertikale l�nge der zweiten Linie

        if (l2x < 3) {
            l2x = 3;
        }

        int l3x = mySize / 10; // Vertikale L�nge der dritten Linie

        if (l3x < 3) {
            l3x = 3;
        }

        final int l4x = mySize / 20; // Verl�ngerung über dritte Linie hinaus, bis Unterobjekt startet

        int l5x = mySize / 20; // Verl�ngerung nach Unterobjekt, bis Abschlusslinie beginnt

        if (l5x < 3) {
            l5x = 3;
        }

        final int l6y = mySize / 5; // L�nge der Abschlusslinie
    ...
    // H�he über der Basislinie des Zeichens. (Basislinie ist die Unterkante eines 'a'. Der Bogen vcm 'g' liegt unterhalb der Basislinie.
    ...
    // H�he unterhalb der Basislinie, also z.B. der Bogen vom 'g'.
