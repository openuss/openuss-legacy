...
public class Letter extends Basic {
    ...
    /*public void paintUncached(Graphics g, int atX, int atY) {
        // So wird die Schriftgr��e korrekt ber�cksichtigt
    ...
    //gg.drawLine(atX,atY-gha,atX+gw,atY-gha);
    //protected final String allowedLetters = "abcdefghijklmnoprstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890=|!%/\\#*+~,.;:-_)(<> []?äöüÄÖÜß";
