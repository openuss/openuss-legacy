...
/**
 * Diese von Canvas abgeleitete Klasse dient als Darstellungfl�che für die Formel
...
public final class FormulaCanvas extends Canvas {
    ...
    /**
     * Erzeugt eine neue Zeichenfl�che
     * @param readonly Die Zeichenfl�che soll nicht bearbeitebar sein.
     * @param leftLine Links soll ein grauer Balken eingeblendet werden
     * @param startSize Größe des gr��ten Buchstaben in Pixeln
     ...
     * @return Cursor-Objekt der Zeichenfl�che
     */
