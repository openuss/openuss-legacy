...
/**
 * Klasse, die die Buttons im Formeleditor erzeugt und mit der Darstellungsfl�che verk�pft.
 */
public final class ButtonField extends Panel implements ActionListener {
    ...
    /**
     * Stellt das Menü zur Verf�gung, dass von dem Formeleditor bereitgestellt wird.
     * @param frame Zielframe, in dem das Menü eingef�gt wird.
     */
...
final class SymbolChoice extends Choice implements ItemListener {
     ...
     * @param sym Modul, in dem das Symbol eingef�gt werden soll
     */
