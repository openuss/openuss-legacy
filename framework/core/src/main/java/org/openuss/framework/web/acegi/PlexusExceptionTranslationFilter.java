 ...
 */
public class PlexusExceptionTranslationFilter implements Filter, InitializingBean {
    //~ Static fields/initializers =====================================================================================

    private static final Log logger = LogFactory.getLog(PlexusExceptionTranslationFilter.class);

	public static final String EXCEPTION_KEY = "org.openuss.framework.web.acegi.PlexusExceptionTranslationFilter.exception";
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            if (ex != null && ex instanceof AcegiSecurityException) {
            	logger.debug("found exception "+ex.getMessage());
            	handleException(request, response, chain, (AcegiSecurityException)ex);
            }
