...
public class FacesUtils {
    ...
    public static Object getManagedBean(String beanName) {
        Object o =
            getValueBinding(el(beanName)).getValue(FacesContext.getCurrentInstance());
    ...
    public static void resetManagedBean(String beanName) {
        getValueBinding(el(beanName)).setValue(FacesContext.getCurrentInstance(),
                                                     null);
    }
     ...
     * @param key unique id within the session
     * @param value scoped object
     */
