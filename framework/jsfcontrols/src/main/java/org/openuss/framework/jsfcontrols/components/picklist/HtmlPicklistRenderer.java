...
public class HtmlPicklistRenderer extends HtmlListboxRendererBase
{
    ...
    private static final String FUNCTION_ADD_TO_SELECTED = "openuss_picklist_addToSelected";
    private static final String FUNCTION_REMOVE_FROM_SELECTED = "openuss_picklist_removeFromSelected";
	...
	private static final Object CLASS_TABLE = "picklist_table";
	private static final Object CLASS_TR = "picklist_tr";
	private static final Object CLASS_TD_LEFT = "picklistLeft";
	private static final Object CLASS_TD_CENTER = "picklistCenter";
	private static final Object CLASS_TD_RIGHT = "picklistRight";
            ...
            throws IOException
    {
        ...
        writer.writeAttribute(HTML.STYLE_CLASS_ATTR, CLASS_TABLE, null);
        writer.startElement(HTML.TR_ELEM, uiComponent);
        writer.writeAttribute(HTML.STYLE_CLASS_ATTR, CLASS_TR, null);
        
        writer.startElement(HTML.TD_ELEM, uiComponent);
        writer.writeAttribute(HTML.STYLE_CLASS_ATTR, CLASS_TD_LEFT, null);
        ...
        // encode buttons
        writer.startElement(HTML.TD_ELEM, uiComponent);
        writer.writeAttribute(HTML.STYLE_CLASS_ATTR, CLASS_TD_CENTER, null);
        ...
        writer.startElement(HTML.TD_ELEM, uiComponent);
        writer.writeAttribute(HTML.STYLE_CLASS_ATTR, CLASS_TD_RIGHT, null);
